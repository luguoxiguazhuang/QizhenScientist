#!/usr/bin/env python3
"""Qwen LLM Chat MCP Server - Supports the DashScope-compatible API

Environment Variables:
    LLM_API_KEY         - API key (required)
    LLM_BASE_URL        - API base URL (default: DashScope compatible endpoint)
    LLM_MODEL           - Model name (default: qwen-plus)
    LLM_FALLBACK_MODEL  - Fallback model on 504 timeout (default: qwen-plus)
...
FALLBACK_MODEL = os.environ.get("LLM_FALLBACK_MODEL", "qwen-plus")
